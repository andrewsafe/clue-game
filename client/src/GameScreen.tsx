...
import { SuggestionOrAccusation, GameScreenProps } from "./types";
...
const GameScreen: React.FC<GameScreenProps> = ({
  ...
  const [moveChoice, setMoveChoice] = useState<string>("");
  const [suggestion, setSuggestion] = useState<SuggestionOrAccusation>({
    character: "",
    weapon: "",
    room: "",
  });
  const [accusation, setAccusation] = useState<SuggestionOrAccusation>({
    character: "",
    weapon: "",
    room: "",
  });
  ...
  return (
    <div className="game-screen">
      ...
      <div>
        ...
        <label htmlFor="suggest-character">Select Suspect:</label>
        <select
          id="suggest-character"
          onChange={(e) =>
        ...
        <label htmlFor="suggest-weapon">Select Weapon:</label>
        <select
          id="suggest-weapon"
          onChange={(e) =>
        ...
        <label htmlFor="suggest-room">Select Room:</label>
        <select
          id="suggest-room"
          onChange={(e) =>
      ...
      <div>
        ...
        <label htmlFor="accuse-character">Select Suspect:</label>
        <select
          id="accuse-character"
          onChange={(e) =>
        ...
        <label htmlFor="accuse-weapon">Select Weapon:</label>
        <select
          id="accuse-weapon"
          onChange={(e) =>
        ...
        <label htmlFor="accuse-room">Select Room:</label>
        <select
          id="accuse-room"
          onChange={(e) =>
